...
case "${1:-all}" in
  ...
  176) SERVICES=(op-17-6); SEMANTIC=("op-17-6:1") ;;
  177) SERVICES=(op-17-7); SEMANTIC=("op-17-7:1") ;;
  all|"") SERVICES=(op-16-6 op-17-4 op-17-5 op-17-6 op-17-7); SEMANTIC=("op-16-6:0" "op-17-4:0" "op-17-5:1" "op-17-6:1" "op-17-7:1") ;;
  *) echo "usage: up.sh [16|174|17|176|177|all]" >&2; exit 2 ;;
esac
