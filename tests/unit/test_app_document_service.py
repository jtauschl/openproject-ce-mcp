...
class _FakeDocumentApi:
    def __init__(self, records: list[DocumentRecord] | None = None) -> None:
        ...
        self.list_all_text_limit_calls: list[int | None] = []
    ...
    async def list_all(
        ...
        self.list_all_text_limit_calls.append(text_limit)
...
async def test_list_defaults_text_limit_to_the_server_setting() -> None:
    ...
    assert api.list_all_text_limit_calls == [77]
...
async def test_list_passes_an_explicit_text_limit_through() -> None:
    ...
    assert api.list_all_text_limit_calls == [10]
