...
sides of the ongoing layered-decomposition migration (client.py's legacy
facade and the Versions app layer's HttpxTransport) and neither may import
from the other, so a neutral shared module is the only way to keep this one
real invariant in a single place instead of duplicated.
"""
