...
other Domain API ports but are NOT honored server-side (verified against
OpenProject's own API implementation): `/api/v3/roles`'s collection representer
